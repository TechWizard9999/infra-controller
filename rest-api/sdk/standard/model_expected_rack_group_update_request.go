...
func (o *ExpectedRackGroupUpdateRequest) GetRacks() []ExpectedRackGroupRack {
	if o == nil {
		var ret []ExpectedRackGroupRack
		return ret
	}
	return o.Racks
}
...
func (o *ExpectedRackGroupUpdateRequest) HasRacks() bool {
	if o != nil && !IsNil(o.Racks) {
		return true
	}
...
// SetRacks gets a reference to the given []ExpectedRackGroupRack and assigns it to the Racks field.
func (o *ExpectedRackGroupUpdateRequest) SetRacks(v []ExpectedRackGroupRack) {
	o.Racks = v
}
